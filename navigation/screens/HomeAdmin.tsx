...
interface EventItem {
  ...
  export default function DashboardScreen() {
    ...
    const [calendarData, setCalendarData] = useState<EventItem[]>([
      { id: '1', titleh1: 'Hostel Meeting', date: '07/12/2024', description: 'For Boys Hostel Students' },
      { id: '2', titleh1: 'Department Meeting', date: '12/12/2024', description: 'ECE Department Block' },
    ]);
    ...
    >
      <View style={styles.horizontalCard}>
        <Text style={styles.cardTitle}>EC200: ECE 3rd Sem</Text>
        <Text style={styles.cardRoom}>Room73</Text>
        <Text style={styles.cardTime}>9:00 - 9:50 AM</Text>
      </View>
      <View style={styles.horizontalCard}>
        <Text style={styles.cardTitle}>EC852: M.Tech 1st Sem</Text>
        <Text style={styles.cardRoom}>Room42</Text>
        <Text style={styles.cardTime}>10:00 - 10:50 AM</Text>
      </View>
      <View style={styles.horizontalCard}>
        <Text style={styles.cardTitle}>EC449: B.Tech 7th Sem</Text>
        <Text style={styles.cardRoom}>Room73</Text>
        <Text style={styles.cardTime}>2:00 - 5:45 PM</Text>
      </View>
