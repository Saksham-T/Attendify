...
// Screens
import ProfileScreen from './screens/ProfileAdmin';
import DashboardScreen from './screens/HomeAdmin.tsx';
import StatsScreen from './screens/StatsAdmin.tsx';
      ...
      screenOptions={({ route }) => ({
        tabBarIcon: ({ focused, color, size }) => {
          ...
          if (route.name === homeName) {
            ...
            iconSource = focused
              ? require('C:/Users/thaku/OneDrive/Desktop/Attendify/Collectify/assets/camera-active.png') // Add your active notification icon
              : require('C:/Users/thaku/OneDrive/Desktop/Attendify/Collectify/assets/camera-inactive.png'); // Add your inactive notification icon
